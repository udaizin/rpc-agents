...
if __name__ == '__main__':
    ...
    if args.without_inner_monologue:
        output_dir = f'./models/Swallow3-8B-{TARGET_INTERLOCUTOR_ID}-v4-QLoRA-{LEARNING_RATE_STR}-wo-im'
    else:
        output_dir = f'./models/Swallow3-8B-{TARGET_INTERLOCUTOR_ID}-v4-QLoRA-{LEARNING_RATE_STR}'
