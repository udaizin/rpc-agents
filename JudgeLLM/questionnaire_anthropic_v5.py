...
OUTPUT_DIR = f'./JudgeLLM/result/eval/anthropic_v5'
...
回答する際には、まず項目ごとに評価の根拠を<reasoning>タグ内に記述してください。その後、適切な評価値（1から7の整数）を<score>タグ内に記入してください。
...
if __name__ == '__main__':
    ...
    for target_interlocutor_id in TARGET_INTERLOCUTOR_IDS:
        ...
        for question in tqdm(questions):
            # TODO: 普通の対話か内心描写付きかでdialogue_listかinner_monologue_listを使い分ける。print消す
